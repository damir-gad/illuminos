       ...
       <section class="about _container">
            <div class="about__content">
                ...
                <div class="about__content-textblock">
                    <div class="about__content-text">В 2024 году мир развлечений обрел нового лидера — компанию ILLUMINOS, онлайн-кинотеатр, который быстро завоевал признание за свои инновационные решения и уникальный подход к предоставлению контента. ILLUMINOS предлагает пользователям не только обширный каталог фильмов и сериалов, но и эксклюзивные новинки, которые невозможно найти нигде больше.</div>
                    <div class="about__content-text">С момента своего основания ILLUMINOS ставит перед собой цель предоставить зрителям не просто качественный контент, но и незабываемый пользовательский опыт. Платформа отличается современным и приятным дизайном, который делает навигацию интуитивно понятной и легкой. Все функции, от поиска до просмотра, продуманы до мелочей, чтобы каждый пользователь мог наслаждаться любимыми фильмами и сериалами без каких-либо преград.</div>
                    <div class="about__content-text">Одним из ключевых преимуществ ILLUMINOS является скорость работы платформы. Мы понимаем, как важно быстро и без задержек переходить к любимому контенту, и поэтому наша система оптимизирована для быстрой отдачи и минимального времени ожидания. Зрители могут мгновенно погружаться в мир кино и сериалов, не теряя времени на долгую загрузку.</div>
                    <div class="about__content-text">В ILLUMINOS мы гордимся своим разнообразием эксклюзивных новинок, которые постоянно обновляются. Наши подписчики получают доступ к самым свежим релизам и уникальному контенту, которого нет на других платформах. Мы стремимся удивлять и радовать наших пользователей, предлагая им только лучшее из мира развлечений.</div>
                    <div class="about__content-text">Присоединяйтесь к ILLUMINOS и откройте для себя новый стандарт онлайн-кинотеатров. Погружайтесь в захватывающие истории, наслаждайтесь исключительным контентом и оцените удобство, которое мы предоставляем каждому нашему зрителю. ILLUMINOS — это не просто кинотеатр, это ваш личный портал в мир качественного и эксклюзивного развлекательного контента.</div>
                </div>
            </div>
            ...
            <div class="footer__wrapper__main-block">
              <nav class="footer__wrapper__main-block-nav">
                <ul class="footer__wrapper__main-block-menu">
                  ...
                  <li class="footer__wrapper__main-block-item">
                    <a href="serials.php" class="footer__wrapper__main-block-link"
                      >Сериалы</a
                    >
                  </li>
                  <li class="footer__wrapper__main-block-item">/</li>
                  <li class="footer__wrapper__main-block-item">
                    <a href="films.php" class="footer__wrapper__main-block-link"
                      >Фильмы</a
                    >
                  </li>
                  <li class="footer__wrapper__main-block-item">/</li>
