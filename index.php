        ...
        <section class="content-block">
          ...
          <?php
            ...
            foreach($series as $series){
              ?>
              <input type="hidden" name="series_id" value="<?= $series[0]?>">
              <div class="content__item">
              <img src="<?php echo $series[1]?>" alt="series" />
        ...
        <section class="content-block">
          ...
          <?php
            ...
            foreach($recommend as $recommend){
              ?>
              <input type="hidden" name="recommend_id" value="<?= $recommend[0]?>">
              <div class="content__item">
              <img src="<?php echo $recommend[1]?>" alt="recommend" />
