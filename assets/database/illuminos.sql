...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Ноя 28 2024 г., 23:50
...
(4, 'news_4.png', 'Новости, новости сериалов', 'Отрывок из сериала «Дети перемен»: готовимся к выходу эксклюзива от ILLUMINOS', 'В интернете появился отрывок из грядущего сериала «Дети перемен». Из небольшого кусочка становится понятна атмосфера всего проекта, и мы уже немного знакомимся с главными героями. Наблюдая за...'),
...
(6, 'news_6.png', 'Новости', 'ILLUMINOS Музыка: как работает новый музыкальный стриминг и почему его стоит установить', 'Встречайте ILLUMINOS Музыку: новую стриминговую платформу для прослушивания музыки, онлайн-радио и другого контента в аудиоформате. Присоединяйтесь к сервису…'),
(7, 'news_7.png', 'Новости, новости сериалов, рекомендации', 'Первая серия музыкального байопика «Комбинация» уже на ILLUMINOS', 'Сегодня в онлайн-кинотеатре ILLUMINOS вышла первая серия самого ожидаемого проекта осени — байопика «Комбинация» про легендарный герлз-бэнд 90-х с Елизаветой Базыкиной, Анастасией Уколовой...'),
...
(12, 'news-card3.png', 'Новости, новости сериалов, что посмотреть', 'Демоны и обмен телами: какие новинки аниме от Amediateka смотрим осенью на ILLUMINOS', 'Азиатская анимация становится все более важным и значимым элементом массовой поп-культуры. Ежегодно в ее фан-клуб прибывают новые поклонники,…');
...
(1, 'assets/img/19.png', 'Счастье', 8.9, 'Сериал'),
